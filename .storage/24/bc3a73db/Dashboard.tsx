...
import { BookOpen, MessageSquare, Upload, Trophy, Clock, Globe, User, Settings, Crown } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const content = {
    en: {
      welcome: subscription?.plan === 'Pro Student' ? "Welcome back, Pro Student!" : "Welcome back, Student!",
    ...
    sw: {
      welcome: subscription?.plan === 'Mwanafunzi Pro' ? "Karibu tena, Mwanafunzi Pro!" : "Karibu tena, Mwanafunzi!",
