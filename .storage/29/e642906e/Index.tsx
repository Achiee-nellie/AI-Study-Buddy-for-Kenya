...
import { CheckCircle, BookOpen, MessageSquare, Camera, Globe, BarChart3, Users, Zap, User, LogOut } from 'lucide-react';
...
export default function LandingPage() {
  ...
  const handlePlanSelect = (plan: any) => {
    ...
    if (plan.name === 'Free' || plan.name === 'Bure') {
      navigate('/dashboard');
    } else if (plan.name === 'School Plan' || plan.name === 'Mpango wa Shule') {
      window.location.href = 'mailto:sales@shulecoach.com?subject=School Plan Inquiry';
    } else {
      setPaymentModal({
        isOpen: true,
        plan: plan
          ...
          {isAuthenticated ? (
            <div className="flex items-center space-x-2">
              <Button variant="ghost" onClick={() => navigate('/dashboard')}>
                ...
                {currentContent.auth.welcome}, {user?.firstName}
              </Button>
            ...
            <Button variant="ghost" onClick={() => setAuthModal(true)}>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              ...
              onClick={() => isAuthenticated ? navigate('/dashboard') : setAuthModal(true)}
            >
